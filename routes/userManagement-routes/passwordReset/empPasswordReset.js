...
const { User } = require("../../../models/userManagement-models/employeeRegistration.model");
const Token = require("../../../models/userManagement-models/token/empToken");
...
router.post("/", async (req, res) => {
	try {
		...
		//creating a URL
		const url = `${process.env.BASE_URL}employee-password-reset/${user._id}/${token.token}/`;
		//send email
