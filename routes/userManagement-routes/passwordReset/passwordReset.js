...
const { User } = require("../../../models/userManagement-models/studentRegistration.model");
const Token = require("../../../models/userManagement-models/token/token");
...
router.post("/", async (req, res) => {
	try {
		...
		//creating a URL
		const url = `${process.env.BASE_URL}student-password-reset/${user._id}/${token.token}/`;
		//send email
